...
const Page8Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page8/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page8/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page8/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page8/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page8/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page8/deleteRole`, params)
