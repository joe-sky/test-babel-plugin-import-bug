...
const Page16Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page16/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page16/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page16/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page16/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page16/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page16/deleteRole`, params)
