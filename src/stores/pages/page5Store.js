...
const Page5Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page5/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page5/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page5/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page5/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page5/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page5/deleteRole`, params)
