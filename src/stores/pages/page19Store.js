...
const Page19Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page19/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page19/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page19/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page19/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page19/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page19/deleteRole`, params)
