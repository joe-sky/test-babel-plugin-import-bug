...
const Page18Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page18/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page18/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page18/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page18/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page18/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page18/deleteRole`, params)
