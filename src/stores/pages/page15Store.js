...
const Page15Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page15/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page15/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page15/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page15/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page15/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page15/deleteRole`, params)
