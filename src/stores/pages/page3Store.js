...
const Page3Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page3/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page3/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page3/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page3/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page3/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page3/deleteRole`, params)
