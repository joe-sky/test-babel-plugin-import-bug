...
const Page14Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page14/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page14/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page14/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page14/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page14/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page14/deleteRole`, params)
