...
const Page10Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page10/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page10/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page10/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page10/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page10/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page10/deleteRole`, params)
