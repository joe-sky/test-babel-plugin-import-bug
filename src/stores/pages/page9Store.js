...
const Page9Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page9/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page9/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page9/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page9/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page9/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page9/deleteRole`, params)
