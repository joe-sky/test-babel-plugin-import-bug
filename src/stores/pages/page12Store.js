...
const Page12Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page12/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page12/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page12/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page12/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page12/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page12/deleteRole`, params)
