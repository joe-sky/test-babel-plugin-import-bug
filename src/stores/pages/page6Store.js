...
const Page6Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page6/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page6/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page6/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page6/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page6/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page6/deleteRole`, params)
