...
const Page20Store = types
  ...
  .actions(self => ({
    ...
    getRoleMenuTree(params) {
      return axios.get(`${__HOST}/page20/getRoleMenuTree`, {
        params
      })
    ...
    getRoleManagementData(params) {
      return axios.get(`${__HOST}/page20/getRoleManagementData`, {
        params
      })
    ...
    searchRole(params) {
      return axios.get(`${__HOST}/page20/searchRole`, {
        params
      })
    ...
    saveRole(params) {
      return axios.post(`${__HOST}/page20/saveRole`, params)
    ...
    saveRolePermission(params) {
      return axios.post(`${__HOST}/page20/saveRolePermission`, params)
    ...
    deleteRole(params) {
      return axios.post(`${__HOST}/page20/deleteRole`, params)
